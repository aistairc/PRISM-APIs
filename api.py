...
Currently, we are providing access to our 5 published NLP models:

- **Named Entity Recognition**
[Demo](http://prm-ezcatdb.cbrc.jp/named_entity_recognition)
- **Relation Extraction**
[Demo](http://prm-ezcatdb.cbrc.jp/relation_extraction)
- **Event Extraction**
[Demo](http://prm-ezcatdb.cbrc.jp/event_extraction)
- **Entity Linking**
[Demo](http://prm-ezcatdb.cbrc.jp/entity_linking)
- **Disease Network**
[Demo](https://prm-ezcatdb.cbrc.jp/disease_network)
...
def disease_network(
    ...
    if all_events:
        ...
        cache_dir = ".cache/api/disease_network"
